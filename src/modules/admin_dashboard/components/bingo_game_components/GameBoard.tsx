                    ...
                    <div className={`grid grid-cols-2 md:grid-cols-3 gap-2`}>
                        {gameNumbers
                            ...
                            .map((number) => (
                                <div
                                    key={number}
                                    className={`w-8 h-8 flex items-center justify-center text-sm border border-blue-200 rounded-full ${rolledNumbers.includes(number) ? "bg-red-300 text-white" : "bg-white text-gray-400"} xl:w-14 xl:h-14 xl:text-lg`}
                                >
                                    {number}
                                </div>
                            ))}
