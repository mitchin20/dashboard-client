...
const Hero = () => {
    ...
    //         // Offset the top position to make it expand more downward
    //         const downwardOffset = 10 + i * 5; // Each ripple slightly more offset downward
    //         ripple.style.top = `${e.clientY - heroElement.getBoundingClientRect().top - radius + downwardOffset}px`;
